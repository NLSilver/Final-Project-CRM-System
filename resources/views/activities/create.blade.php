    ...
    <div class="max-w-4xl mx-auto mt-8 pb-20">
        <form action="{{ route('activities.store') }}" method="POST" class="space-y-6">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                    <div>
                        ...
                        <select name="activity_type" 
                                class="w-full border-b border-gray-200 px-0 py-2 focus:ring-0 focus:border-blue-500 text-sm font-bold uppercase">
                    ...
                    <div>
                        ...
                        <input type="date" name="activity_date" value="{{ old('activity_date', date('Y-m-d')) }}" 
                               class="w-full border-b border-gray-200 px-0 py-2 focus:ring-0 focus:border-blue-500 text-sm">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3" placeholder="What was discussed?"
                                  class="w-full border-b {{ $errors->has('description') ? 'border-red-500' : 'border-gray-200' }} px-0 py-2 focus:ring-0 focus:border-blue-500 text-sm italic">{{ old('description') }}</textarea>
                    ...
                    @if(!request()->has('id'))
                        <div class="md:col-span-1">
                            ...
                            <select name="customer_id" class="w-full border-b border-gray-200 px-0 py-2 focus:ring-0 focus:border-blue-500 text-sm">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <select name="lead_id" class="w-full border-b border-gray-200 px-0 py-2 focus:ring-0 focus:border-blue-500 text-sm">
                                <option value="">None</option>
                                @foreach($leads as $l)
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ url()->previous() }}" class="text-sm font-bold text-gray-400 py-2 px-4 hover:text-gray-600 transition">Cancel</a>
                <button type="submit" class="bg-teal-600 hover:bg-teal-700 text-white px-10 py-2 rounded-md text-sm font-bold shadow-lg transition uppercase tracking-widest">
                    Log Activity
                </button>
            </div>
        </form>
