                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100">
                        <tbody class="divide-y divide-gray-50">
                            @forelse($customerActivities as $activity)
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="px-4 sm:px-6 py-4 text-right">
                                        <form action="{{ route('activities.destroy', $activity) }}" method="POST" onsubmit="return confirm('Delete this activity log?')">
                                            @csrf @method('DELETE')
                            ...
                            @empty
                                <tr><td class="px-6 py-10 text-center text-xs text-gray-400 italic">No customer interaction records found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100">
                        <tbody class="divide-y divide-gray-50">
                            ...
                            @empty
                                <tr><td class="px-6 py-10 text-center text-xs text-gray-400 italic">No lead interaction records found.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
