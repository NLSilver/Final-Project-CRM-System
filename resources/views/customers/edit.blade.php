...
<x-app-layout>
    <div class="max-w-4xl mx-auto lg:mt-8">
        ...
        <form action="{{ route('customers.update', $customer) }}" method="POST" class="space-y-6 pb-20">
            @csrf
            @method('PUT')
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="email" name="email" value="{{ old('email', $customer->email) }}" required 
                               class="w-full border-b border-gray-200 border-t-0 border-l-0 border-r-0 px-0 py-2 focus:ring-0 focus:border-teal-500 text-sm bg-transparent">
                    </div>
            ...
            <div class="bg-white shadow-sm border border-gray-200 rounded-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <label class="block text-[11px] uppercase font-bold text-gray-400 mb-1">Current Staff ID</label>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-4 pt-4">
                <a href="{{ url()->previous() }}" class="text-sm font-semibold text-gray-400 hover:text-gray-600 transition order-2 sm:order-1">
                    Discard Changes
                </a>
