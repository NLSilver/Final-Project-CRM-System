        ...
        <div class="space-y-6 mb-10">
            <div class="bg-white shadow-sm border border-gray-200 rounded-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                    <div>
                        ...
                        <p class="text-sm text-blue-600 font-medium">{{ $customer->email }}</p>
                    </div>
            ...
            <div class="mt-8 bg-white p-6 rounded shadow-sm border border-gray-100">
                <div class="px-2 flex justify-between items-center text-[10px] text-gray-400 uppercase font-bold tracking-widest">
                    ...
                    <span>Last Activity: {{ $customer->updated_at ? $customer->updated_at->diffForHumans() . ' (' . $customer->updated_at->format('M d, Y h:i A') . ')' : 'No activity yet' }}</span>
                </div>
                ...
                <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-100">
                    ...
                    @else
                        <a href="{{ route('customers.edit', $customer) }}" class="bg-teal-600 hover:bg-teal-700 text-white px-8 py-2.5 rounded-md text-sm font-bold transition shadow-md">
                            Edit Customer
                        </a>
                    @endif
            </div>
