            ...
            <div class="bg-white shadow-sm border border-gray-200 rounded-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="3" class="w-full border-b border-gray-200 border-t-0 border-l-0 border-r-0 px-0 py-2 focus:ring-0 focus:border-teal-500 text-sm text-gray-600 bg-gray-50/30">{{ old('notes', $lead->notes) }}</textarea>
                    </div>
                </div>
            </div>

            <div class="flex items-center justify-end space-x-4 pt-4 mb-10">
                <a href="{{ url()->previous() }}" class="text-sm font-semibold text-gray-400">Cancel Changes</a>
